...
if (isProduction) {
  ...
  dbConfig = {
    ...
    entities: [User, Admin, Category, Property, RoomType, Like, Notification, RegionalSection, Booking, Transfer, CommissionSettings, require('../models/OwnerApplication').OwnerApplication],
